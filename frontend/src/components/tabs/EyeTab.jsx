...
import { 
  Focus, ZoomIn, Info, ArrowRightLeft, Sliders, Maximize2, AlertTriangle, Check, Copy, Eye as EyeIcon, Loader2
} from 'lucide-react';
  ...
  const makeFallbackSvg = useCallback((type) => {
    if (type === 'landmark_6p') {
      return 'data:image/svg+xml;utf8,' + encodeURIComponent(`
        <svg xmlns="http://www.w3.org/2000/svg" width="380" height="380" viewBox="0 0 380 380">
          ...
          <text x="190" y="32" fill="rgba(255,255,255,0.6)" font-size="10" text-anchor="middle" font-family="monospace">6-POINT OCULAR LANDMARK GEOMETRY</text>
          
          <!-- Eye outline mesh -->
          <g transform="translate(40, 100)">
            <ellipse cx="150" cy="80" rx="110" ry="50" fill="none" stroke="rgba(255,255,255,0.15)" stroke-width="1.5" />
            
            <!-- P1 through P6 landmarks -->
            <circle cx="40" cy="80" r="5" fill="#38bdf8" />
            <text x="25" y="84" fill="#38bdf8" font-size="9" font-family="monospace">P1</text>
            
            <circle cx="95" cy="45" r="5" fill="#38bdf8" />
            <text x="95" y="35" fill="#38bdf8" font-size="9" font-family="monospace" text-anchor="middle">P2</text>
            
            <circle cx="205" cy="45" r="5" fill="#38bdf8" />
            <text x="205" y="35" fill="#38bdf8" font-size="9" font-family="monospace" text-anchor="middle">P3</text>
            
            <circle cx="260" cy="80" r="5" fill="#38bdf8" />
            <text x="275" y="84" fill="#38bdf8" font-size="9" font-family="monospace">P4</text>
            
            <circle cx="205" cy="115" r="5" fill="#38bdf8" />
            <text x="205" y="132" fill="#38bdf8" font-size="9" font-family="monospace" text-anchor="middle">P5</text>
            
            <circle cx="95" cy="115" r="5" fill="#38bdf8" />
            <text x="95" y="132" fill="#38bdf8" font-size="9" font-family="monospace" text-anchor="middle">P6</text>

            <!-- Vertical aperture vectors (||P2 - P6|| and ||P3 - P5||) -->
            <line x1="95" y1="45" x2="95" y2="115" stroke="#f59e0b" stroke-width="2" stroke-dasharray="3 3" />
            <line x1="205" y1="45" x2="205" y2="115" stroke="#f59e0b" stroke-width="2" stroke-dasharray="3 3" />
            
            <!-- Horizontal axis (||P1 - P4||) -->
            <line x1="40" y1="80" x2="260" y2="80" stroke="#38bdf8" stroke-width="1.5" />
          </g>

          <text x="190" y="315" fill="#f59e0b" font-size="10" text-anchor="middle" font-family="monospace">
            EAR = (||P2-P6|| + ||P3-P5||) / (2 · ||P1-P4||)
          </text>
          <text x="190" y="340" fill="rgba(255,255,255,0.4)" font-size="9" text-anchor="middle" font-family="monospace">
            68-FACIAL LANDMARK APERTURE RATIO
          </text>
        </svg>
      `);
    }
    ...
    if (type === 'gaze_stereo') {
      return 'data:image/svg+xml;utf8,' + encodeURIComponent(`
        <svg xmlns="http://www.w3.org/2000/svg" width="380" height="380" viewBox="0 0 380 380">
          <rect width="380" height="380" fill="#030610" />
          <text x="190" y="32" fill="rgba(255,255,255,0.6)" font-size="10" text-anchor="middle" font-family="monospace">BILATERAL GAZE CONVERGENCE</text>
          
          <!-- Left Eye -->
          <ellipse cx="120" cy="160" rx="50" ry="28" fill="#0b1120" stroke="rgba(255,255,255,0.2)" stroke-width="1.5" />
          <circle cx="125" cy="160" r="14" fill="#030610" stroke="#38bdf8" stroke-width="1.5" />
          <circle cx="125" cy="160" r="6" fill="#38bdf8" />
          
          <!-- Right Eye -->
          <ellipse cx="260" cy="160" rx="50" ry="28" fill="#0b1120" stroke="rgba(255,255,255,0.2)" stroke-width="1.5" />
          <circle cx="255" cy="160" r="14" fill="#030610" stroke="#38bdf8" stroke-width="1.5" />
          <circle cx="255" cy="160" r="6" fill="#38bdf8" />

          ${isAnomaly ? `
            <!-- Asymmetric divergent gaze vectors -->
            <line x1="125" y1="160" x2="90" y2="280" stroke="#f43f5e" stroke-width="2" stroke-dasharray="4 3" />
            <line x1="255" y1="160" x2="290" y2="280" stroke="#f43f5e" stroke-width="2" stroke-dasharray="4 3" />
            <text x="190" y="80" fill="#f43f5e" font-size="11" text-anchor="middle" font-family="monospace" font-weight="bold">DIVERGENT PUPILLARY GAZE AXES</text>
          ` : `
            <!-- Convergent gaze vectors meeting at focal point -->
            <line x1="125" y1="160" x2="190" y2="270" stroke="#10b981" stroke-width="2" />
            <line x1="255" y1="160" x2="190" y2="270" stroke="#10b981" stroke-width="2" />
            <circle cx="190" cy="270" r="4" fill="#10b981" />
            <text x="190" y="80" fill="#10b981" font-size="11" text-anchor="middle" font-family="monospace" font-weight="bold">CONVERGENT BINOCULAR FOCAL POINT</text>
          `}
          <text x="190" y="340" fill="rgba(255,255,255,0.4)" font-size="9" text-anchor="middle" font-family="monospace">
            3D STEREO PUPILLARY VECTOR PROJECTION
          </text>
        </svg>
      `);
    }
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
              {exhibits.map((ex) => {
                ...
                return (
                  ...
                  >
                    {ex.id === 'ear_curve' ? 'EAR Curve' : ex.id === 'landmark_6p' ? '6-Pt Mesh' : 'Stereo Gaze'}
                  </button>
                );
              })}
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.2rem', marginLeft: '0.25rem' }}>
                ...
                />
                <span className="mono-font" style={{ fontSize: '0.62rem', width: '22px' }}>{earThreshold.toFixed(2)}</span>
              </div>
            ...
            {stageMode === 'wipe' && (
              ...
              >
                <img 
                  src={originalFaceUrl} 
                  alt="" 
                  onError={(e) => handleFaceImgError(e, makeFallbackSvg('ear_curve'))}
                  style={{ 
                    width: '100%', 
                    height: '100%', 
                    objectFit: 'contain' 
            ...
            {hudCoords && (
              ...
              >
                ...
                <div style={{ display: 'flex', gap: '8px', color: '#94a3b8' }}>
                  <span>State: {hudCoords.state}</span>
                  <span>Frame: #{hudCoords.frame}</span>
                </div>
              </div>
            )}
          </div>
